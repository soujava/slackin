  ...
  .end(function (err, res){
    ...
    if (!ok) {
      if (providedError === 'missing_scope' && needed === 'admin') {
        ...
        fn(new Error('Você já foi convidado para esta comunidade do Slack anteriormente. Por favor, veja em seu e-mail uma mensagem de feedback@slack.com.'))
      } else if (providedError === 'already_in_team') {
        fn(new Error(`Enviando você para o Slack...`))
      } else {
